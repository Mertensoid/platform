...
// Fabric function with lifecycle type
type BindingMap struct {
	factoryFunc reflect.Value
	lifecycle
}

// Service registration. Just adding BindingMap to map.
...
func resolveScopedService(c context.Context,
	val reflect.Value, binding BindingMap) (err error) {
...
func resolveFunctionArguments(c context.Context,
	f reflect.Value, otherArgs ...interface{}) []reflect.Value {
...
func invokeFunction(c context.Context,
	f reflect.Value, otherArgs ...interface{}) []reflect.Value {
